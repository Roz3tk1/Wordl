const words = {
    english: ["apple", "grape", "peach", "berry", "melon", "lemon", "mango", "plumb", "guava", "melon", "candy", "fuzzy", "piano", "tiger", "zebra"],
};
...
if (localStorage.getItem('totalGames')) {
    ...
    wonGames = parseInt(localStorage.getItem('wonGames'));
    updateCounters();
}

function updateCounters() {
    document.getElementById('total-games').textContent = totalGames;
    document.getElementById('won-games').textContent = wonGames;
}
...
function clearStatistics() {
    ...
    localStorage.removeItem('wonGames');
    updateCounters();
}
...
document.getElementById('clear-stats-btn').addEventListener('click', () => {
    clearStatistics();
    showMessage('Статистика очищена!');
});
